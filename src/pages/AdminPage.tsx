...
const TERMINVERWALTUNG_FIELDS = [
  ...
  { key: 'termindatum', label: 'Datum und Uhrzeit', type: 'date/datetimeminute' },
  { key: 'terminart', label: 'Terminart', type: 'lookup/select', options: [{ key: 'erstgespraech', label: 'Erstgespräch' }, { key: 'beratung', label: 'Beratung' }, { key: 'folgetermin', label: 'Folgetermin' }, { key: 'praesentation', label: 'Präsentation' }, { key: 'vertragsabschluss', label: 'Vertragsabschluss' }, { key: 'sonstiges', label: 'Sonstiges' }] },
  { key: 'dauer', label: 'Dauer (in Minuten)', type: 'number' },
  { key: 'ort', label: 'Ort / Raum', type: 'string/text' },
  { key: 'status', label: 'Status', type: 'lookup/radio', options: [{ key: 'geplant', label: 'Geplant' }, { key: 'bestaetigt', label: 'Bestätigt' }, { key: 'abgesagt', label: 'Abgesagt' }, { key: 'abgeschlossen', label: 'Abgeschlossen' }] },
...
const KUNDENVERWALTUNG_FIELDS = [
  ...
  { key: 'notizen_kunde', label: 'Notizen zum Kunden', type: 'string/textarea' },
];
