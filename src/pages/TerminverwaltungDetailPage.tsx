...
export default function TerminverwaltungDetailPage() {
  ...
  return (
    ...
    >
      <RecordHeader title={record.fields.ort ?? 'Terminverwaltung'} />
      ...
      <RecordSection title="Details" cols={2}>
        ...
        <RecordField label="Datum und Uhrzeit" value={record.fields.termindatum} format="datetime" />
        <RecordField label="Terminart" value={record.fields.terminart} format="pill" />
        <RecordField label="Dauer (in Minuten)" value={record.fields.dauer} format="text" />
        <RecordField label="Ort / Raum" value={record.fields.ort} format="text" />
