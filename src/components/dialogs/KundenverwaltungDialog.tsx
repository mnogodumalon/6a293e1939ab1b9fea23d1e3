...
export function KundenverwaltungDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: KundenverwaltungDialogProps) {
  ...
  useEffect(() => {
    if (open) {
      setFields(applyDefaults((defaultValues ?? {}) as Record<string, unknown>, formEnhancements.defaults) as Partial<Kundenverwaltung['fields']>);
      setPreview(null);
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'notizen_kunde': (
      <div key="notizen_kunde" className="space-y-1.5">
        <Label htmlFor="notizen_kunde">Notizen zum Kunden</Label>
        <Textarea
          id="notizen_kunde"
          placeholder="Branche, Größe, Priorität, besondere Wünsche..."
  ...
  const FIELD_LABELS: Record<string, string> = {"vorname": "Vorname", "nachname": "Nachname", "email": "E-Mail-Adresse", "telefon": "Telefonnummer", "strasse": "Straße", "hausnummer": "Hausnummer", "plz": "Postleitzahl", "ort": "Ort", "notizen_kunde": "Notizen zum Kunden"};
